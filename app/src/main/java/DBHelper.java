...
public class DBHelper {
    ...
    public ArrayList<Note> readNotes (String username){
        ...
        createTable();;
        Cursor c = sqLiteDatabase.rawQuery(String.format("SELETC * from notes where username like '%s'", username), null);
    ...
    public void saveNotes(String username, String title, String content, String date){
        createTable();
        sqLiteDatabase.execSQL(String.format("INSET INTO notes (username, date, title, content) VALUES ('%s', '%s', '%s', '%s')",
